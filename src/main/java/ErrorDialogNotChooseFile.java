...
public class ErrorDialogNotChooseFile extends JFrame {
    ...
    public ErrorDialogNotChooseFile() {
        super("Ошибка");
...
//        label1 = new JLabel("<html><div style='text-align: center;','line-height: 3.5;'>" + "Пожалуйста, выберите файл для<br>редкатирования" + "</div></html>");
        label1 = new JLabel("<html><div style='text-align: center;','line-height: 3.5;'>" + "Ну и какого х.я ты файл не выбрал/а?<br>Жми выбрать файл и выбирай прайс Excel" + "</div></html>");
        label1.setFont(font);
